...
export default function CreateChatForm({onClose}) {
    ...
    return (
        ...
        <form className="chat-form" onSubmit={handleSubmit} id="chat-form">
                ...
                <input className="chat-form_input" type="text" name="firstName" placeholder="Enter first name" minLength={1} required/>

                <label className="chat-form_label" htmlFor="lastName">Last name:</label>
                <input className="chat-form_input" type="text" name="lastName"  placeholder="Enter last name" minLength={1} required/>
